{
  ...
  parseIni = text: let
    ...
    processed = builtins.foldl' (acc: line: let
  ...
  upstreamSettings =
    ...
    else lib.warn "caelestia-dots: upstream foot/foot.ini not found, using minimal defaults." {
      main = {
        shell = "fish";
        title = "foot";
